...
const FEATURES: { icon: LucideIcon; title: string; desc: string; badge?: string; stat?: string }[] = [
  ...
  { icon: ShieldAlert, title: 'Fraud detection', desc: 'Flag irregular vouchers and preserve a complete review trail', stat: 'Real-time' },
  { icon: Building2, title: 'Inspection cross-check', desc: 'Link field inspection findings to the exact voucher and billed act', stat: 'Cross-check' },
  { icon: BarChart3, title: 'Interactive analytics', desc: 'Visualize claim patterns and deductions', badge: 'NEW', stat: '6 charts' },
  { icon: FileCheck, title: 'Counter verification', desc: 'Generate medical counter verification reports with act-level deductions', stat: '3 reports' },
...
const STEPS: { num: string; icon: LucideIcon; title: string; desc: string }[] = [
  { num: '01', icon: Search, title: 'Review', desc: 'Upload medical voucher files. Columns auto-map, data is normalized, and every record is ready for counter verification.' },
  { num: '02', icon: ShieldCheck, title: 'Verify', desc: 'Review each voucher, apply deductions, flag fraud, and cross-reference against field inspection findings.' },
          ...
          <div className="relative">
            ...
            <div className="lg:pl-8">
              ...
              <p className="ishema-rise ishema-rise-3 text-slate-300 text-base sm:text-lg leading-relaxed mb-8 max-w-xl">
                Prepare, verify and audit medical voucher claims — map columns, review vouchers,
      ...
      <footer className="relative px-4 sm:px-6 lg:px-10 py-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-xs text-slate-400">
            RSSB Counter Verification System · Medical claims verification &amp; fraud detection
          </p>
  ...
  return (
    <div className="ishema-mockup relative">
      ...
      <div className="ishema-mockup-bar flex items-center gap-2 px-4 py-2.5">
        ...
        <span className="text-[10px] text-white/60">Alliance Medical</span>
      </div>
