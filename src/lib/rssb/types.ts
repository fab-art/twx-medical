...
export type MedicalActKey = 'consultation' | 'laboratory' | 'imaging' | 'hospital' | 'procedures' | 'other_consumables' | 'medicines';

export type ActDeductionMap = Record<MedicalActKey, number>;
export type ActReasonMap = Record<MedicalActKey, string>;
...
export interface Card {
  ...
  actDeductions: ActDeductionMap;
  actReasons: ActReasonMap;
...
export type FieldKey =
  ...
  | 'consultation' | 'laboratory' | 'imaging' | 'hospital' | 'procedures' | 'other_consumables' | 'medicines';
...
export type Stage =
  ...
  | 'dashboard' | 'analytics' | 'inspection' | 'hospital' | 'match'
